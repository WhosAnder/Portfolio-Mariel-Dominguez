...
import { AnimationCleanupSection } from "@/components/animation-cleanup-section"
    ...
    <main className="min-h-screen">
      ...
      <footer className="bg-card/10 border-t border-border py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-muted-foreground">© 2026 Mariel Domínguez. All rights reserved.</p>
